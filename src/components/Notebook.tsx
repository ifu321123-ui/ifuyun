...
import { notebook, profile } from "@/data"
...
function StickyBeliefNote({
  text,
  paper,
}: (typeof notebook.beliefs)[number]) {
  return (
    <div className="notebook-note notebook-note--sticky">
      <img src={paper} alt="" className="notebook-note-paper" />
      <div className="notebook-sticky-inner">
        <p className="notebook-note-text font-serif italic">{text}</p>
...
function CollageNote() {
  return (
    <div className="notebook-collage-top">
      <div className="notebook-collage">
        <img
          src="/notebook/collage-script.png"
          alt=""
          className="notebook-collage-layer notebook-collage-script"
        />
        <div className="notebook-collage-lined-wrap">
          <img
            src="/notebook/collage-lined.png"
            alt=""
            className="notebook-collage-layer notebook-collage-lined"
          />
          <div className="notebook-collage-text font-gochi">
            <a href={`mailto:${profile.email}`} className="notebook-collage-entry">
              <span className="notebook-collage-label">邮箱</span>
              <span className="notebook-collage-value">{profile.email}</span>
            </a>
            <a href={`tel:${profile.phone}`} className="notebook-collage-entry">
              <span className="notebook-collage-label">电话</span>
              <span className="notebook-collage-value">{profile.phone}</span>
            </a>
          </div>
        </div>
        <img
          src="/notebook/collage-star.png"
          alt=""
          className="notebook-collage-layer notebook-collage-star"
        />
        <img
          src="/notebook/collage-clip.png"
          alt=""
          className="notebook-collage-layer notebook-collage-clip"
        />
      </div>
    </div>
  )
        ...
        >
            ...
            <div className={`notebook-top-wrap ${topPress ? "is-pressed" : ""}`}>
              ...
              >
                ...
                <div className="notebook-top-inner">
                  <div className="notebook-intro-col">
          ...
          <div className="notebook-bottom-outer">
            ...
            <div className="notebook-paper notebook-paper--bottom">
              ...
              <div className="notebook-bottom-content">
                <div className="notebook-notes">
                  {notebook.beliefs.map((belief) =>
                    belief.className === "notebook-note--sticky" ? (
                      <StickyBeliefNote key={belief.text} {...belief} />
                    ) : (

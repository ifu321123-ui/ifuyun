...
export const junniSolutions: JunniSolution[] = [
  {
    num: "01",
    name: "教育背景",
    detail: "成都锦城学院 · 数字媒体技术 · 2023.09 — 2027.06",
    body: {
      groups: [
        {
          subtitle: "专业学习",
          ...
          points: [
            {
              label: "食援",
              value:
                "《食援》是一款以「药食同源」「乡村振兴」「以食为援」为核心理念。该 App 旨在让用户深入了解中医药膳文化，将药膳食材知识普及与乡村振兴助农融于一体的综合型平台。让用户「懂药膳、选好材」，同时助力农户增收，推动乡村产业振兴。",
            },
            {
              label: "蜀香",
              value:
            ...
            },
            {
              label: "一地人间",
              value:
                "本网页以「中国人的土地情感」为叙事核心，构建一部跨越时空的农业记忆长卷。在设计上，我们融合传统与现代的视觉语言，借助互动体验、可视化技术和用户共创机制，呈现农业发展轨迹，同时唤醒用户内心深处与泥土相连的情感记忆。",
            },
          ],
        },
        {

...
export const projects: Project[] = [
  ...
  },
  {
    category: "创新设计" as ProjectCategory,
    title: "一地人间",
    desc: "本网页以「中国人的土地情感」为叙事核心，构建一部跨越时空的农业记忆长卷。在设计上，我们融合传统与现代的视觉语言，借助互动体验、可视化技术和用户共创机制，呈现农业发展轨迹，同时唤醒用户内心深处与泥土相连的情感记忆。",
    loop: "创意概念：土地情感与农业记忆数字化；核心亮点：传统与现代视觉融合、互动体验与用户共创；价值输出：唤醒用户与泥土相连的情感共鸣。",
    tags: ["文化设计", "叙事体验"],
  },
  {
    category: "创新设计" as ProjectCategory,
    ...
    desc: "《食援》是一款以「药食同源」「乡村振兴」「以食为援」为核心理念。该 App 旨在让用户深入了解中医药膳文化，将药膳食材知识普及与乡村振兴助农融于一体的综合型平台。让用户「懂药膳、选好材」，同时助力农户增收，推动乡村产业振兴。",
    loop: "创意概念：药食同源 × 乡村振兴 × 以食为援；核心亮点：药膳科普、助农电商与用户选材体验；价值输出：懂药膳、选好材，助力农户增收与乡村产业振兴。",
    meta: {
      client: "蓝桥杯大赛参赛作品",
